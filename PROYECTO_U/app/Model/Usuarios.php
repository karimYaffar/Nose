 ...
 class Usuario {
    ...
    public function insertarUsuario($nombre, $apellidoPaterno, $apellidoMaterno, $password, $telefono, $correo, $colonia, $municipio, $localidad, $codigoPostal, $referencia, $numeroCuenta, $fechaVencimientoMes, $fechaVencimientoAno, $nip, $titular) {
        ...
        try {
            ...
            $sql = "INSERT INTO usuarios ( ID_usuario, Nombre, Apaterno, Amaterno, Password, telefono, Correo, fk_direccion, ID_cuenta_bancaria)
                    VALUES ($nombre', '$apellidoPaterno', '$apellidoMaterno', '$password', '$Telefono', '$Correo', '$FK_direccion', '$cuentaId')";
            $conexion->query($sql);
